...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '969099516 1395772318').split()]
...
DATABASE_NAME = environ.get('DATABASE_NAME', "Waldyfiles")
